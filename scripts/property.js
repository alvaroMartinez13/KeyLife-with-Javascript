import { cargarDatos, guardarDatos_LocalStorage } from "./data.js";
...
function crearCartas() {
  ...
  for (let i = 0; i < properties.length; i++) {
    cartas += `
    <a id="carta-${i}" class="card apartamento1 apartamento" href="info-inmueble.html" style="background-image: url(${properties[i].image_property})">
        <div class="corazon">
            <h1 class="id-property" style="display:none;">${properties[i].id_property}</h1>
            <svg style="cursor:pointer" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FFFFFF"><path d="m480-120-58-52q-101-91-167-157T150-447.5Q111-500 95.5-544T80-634q0-94 63-157t157-63q52 0 99 22t81 62q34-40 81-62t99-22q94 0 157 63t63 157q0 46-15.5 90T810-447.5Q771-395 705-329T538-172l-58 52Zm0-108q96-86 158-147.5t98-107q36-45.5 50-81t14-70.5q0-60-40-100t-100-40q-47 0-87 26.5T518-680h-76q-15-41-55-67.5T300-774q-60 0-100 40t-40 100q0 35 14 70.5t50 81q36 45.5 98 107T480-228Zm0-273Z"/></svg>
        </div>
  ...
  // Agregar evento click a todas las cartas
  ...
  todasLasCartas.forEach(carta => {
    carta.addEventListener('click', function(event) {
      ...
      const idPropertyElement = this.querySelector('.id-property');
      if (idPropertyElement) {
        const idProperty = idPropertyElement.textContent;
        
        // Guardar datos en el localStorage
        guardarDatos_LocalStorage(idProperty, "Property");
        
        // Redirigir a la página de información del inmueble
        window.location.href = this.getAttribute('href');
      } else {
        console.error('No se pudo encontrar el elemento .id-property');
      }
    });
  });
}
